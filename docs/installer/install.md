...
![IB Link のアンインストール選択](images/page-040_img-051.png)
...
![削除コンポーネント選択画面](images/page-040_img-052.png)
...
![Database を含めた削除設定（パスワード入力）](images/page-040_img-053.png)
...
![Vulkan SDK / Git の削除を含めた選択例](images/page-040_img-054.png)
...
![IB Link 削除の確認](images/page-040_img-055.png)
...
![アンインストール進行中](images/page-040_img-056.png)
...
![アンインストール完了メッセージ](images/page-040_img-057.png)
